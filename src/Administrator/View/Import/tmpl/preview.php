...
/** @var \CategoryImport\Component\CategoryImport\Administrator\View\Import\HtmlView $this */

// No direct access
defined('_JEXEC') or die;
?>

<form action="<?php echo Route::_('index.php?option=com_tagimport&task=import.import'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					...
					<div class="alert alert-info" style="background-color: #1a1a1a !important; color: #00ff00 !important; border: 2px solid #00ff00 !important; box-shadow: 0 0 8px rgba(0, 255, 0, 0.3) !important; font-weight: bold !important;">
						...
						<?php echo Text::sprintf('COM_TAGIMPORT_PREVIEW_DESCRIPTION', $this->total); ?>
					</div>
									...
									<?php if ($i >= 10) : ?>
										<tr>
											<td colspan="5" class="text-center" style="color: #00ff00 !important; border: 1px solid #ffffff !important; padding: 10px !important; font-weight: bold !important;">
												<?php echo Text::sprintf('COM_TAGIMPORT_MORE_ITEMS', $this->total - 10); ?>
											</td>
										</tr>
										<?php break; ?>
									<?php endif; ?>
